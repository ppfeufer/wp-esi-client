...
namespace WordPress\EsiClient\Model\Universe\Types;
...
class TypeId {
    ...
    protected function setDogmaAttributes(array $dogmaAttributes) {
        ...
        $this->dogmaAttributes = $mapper->mapArray($dogmaAttributes, [], '\\WordPress\EsiClient\Model\Universe\Types\TypeId\Dogma\Attributes');
    }
    ...
    protected function setDogmaEffects(array $dogmaEffects) {
        ...
        $this->dogmaEffects = $mapper->mapArray($dogmaEffects, [], '\\WordPress\EsiClient\Model\Universe\Types\TypeId\Dogma\Effects');
    }
