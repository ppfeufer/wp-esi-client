...
class Ids {
    ...
    protected function setAgents(array $agents) {
        ...
        $this->agents = $mapper->mapArray($agents, [], '\\WordPress\EsiClient\Model\Universe\Ids\Agents');
    }
    ...
    protected function setAlliances(array $alliances) {
        ...
        $this->alliances = $mapper->mapArray($alliances, [], '\\WordPress\EsiClient\Model\Universe\Ids\Alliances');
    }
    ...
    protected function setCharacters(array $characters) {
        ...
        $this->characters = $mapper->mapArray($characters, [], '\\WordPress\EsiClient\Model\Universe\Ids\Characters');
    }
    ...
    protected function setConstellations(array $constellations) {
        ...
        $this->constellations = $mapper->mapArray($constellations, [], '\\WordPress\EsiClient\Model\Universe\Ids\Constellations');
    }
    ...
    protected function setCorporations(array $corporations) {
        ...
        $this->corporations = $mapper->mapArray($corporations, [], '\\WordPress\EsiClient\Model\Universe\Ids\Corporations');
    }
    ...
    protected function setFactions(array $factions) {
        ...
        $this->factions = $mapper->mapArray($factions, [], '\\WordPress\EsiClient\Model\Universe\Ids\Factions');
    }
    ...
    protected function setInventoryTypes(array $inventoryTypes) {
        ...
        $this->inventoryTypes = $mapper->mapArray($inventoryTypes, [], '\\WordPress\EsiClient\Model\Universe\Ids\InventoryTypes');
    }
    ...
    protected function setRegions(array $regions) {
        ...
        $this->regions = $mapper->mapArray($regions, [], '\\WordPress\EsiClient\Model\Universe\Ids\Regions');
    }
    ...
    protected function setStations(array $stations) {
        ...
        $this->stations = $mapper->mapArray($stations, [], '\\WordPress\EsiClient\Model\Universe\Ids\Stations');
    }
    ...
    protected function setSystems(array $systems) {
        ...
        $this->systems = $mapper->mapArray($systems, [], '\\WordPress\EsiClient\Model\Universe\Ids\Systems');
    }
}
