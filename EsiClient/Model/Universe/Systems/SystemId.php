...
namespace WordPress\EsiClient\Model\Universe\Systems;

use \WordPress\EsiClient\Mapper\JsonMapper;
use \WordPress\EsiClient\Model\Universe\Systems\SystemId\Position;
...
class SystemId {
    ...
    protected function setPlanets(array $planets) {
        ...
        $this->planets = $mapper->mapArray($planets, [], '\\WordPress\EsiClient\Model\Universe\Systems\SystemId\Planets');
    }
